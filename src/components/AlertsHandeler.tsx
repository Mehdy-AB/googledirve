...
const AlertsHandeler=()=>{
    const {
      ...
      return(
        ...
        {/* <!-- Alert Success --> */}
        if(alert.type ===1)
        return(<div key={index} className="bg-green-200 px-6 py-4 my-4 rounded-md text-lg flex items-center mx-auto max-w-lg">
        ...
        {/* <!-- Alert Error --> */}
        if(alert.type ===2)
            return(<div key={index} className="bg-red-200 px-6 py-4 my-4 rounded-md text-lg flex items-center mx-auto max-w-lg">
        ...
        {/* <!-- Alert Warning --> */}
        if(alert.type ===3)
            return(<div key={index} className="bg-orange-200 px-6 py-4 my-4 rounded-md text-lg flex items-center mx-auto max-w-lg">
        ...
        {/* <!-- Alert Info --> */}
        if(alert.type ===4)
            return(<div key={index} className="bg-blue-200 px-6 py-4 my-4 rounded-md text-lg flex items-center mx-auto max-w-lg">
