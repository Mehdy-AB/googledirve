...
const SideBar = ({ sidebarOpen, setSidebarOpen }: { sidebarOpen: boolean; setSidebarOpen: (open: boolean) => void }) => {
    ...
    return (
      <div className={`fixed z-[100] ${sidebarOpen ? "w-[12rem]" : "w-[4rem]"} duration-300 ease-linear h-[100%] drop-shadow-md bg-foreground`}>
        ...
        <div onClick={()=>{router.push("/")}} className=" flex border-b-2 items-center border-gray-400 border-opacity-20 hover:opacity-50 py-2 p-1 cursor-pointer">
        <div className=" ml-3">
        ...
        <div onClick={()=>{router.push("/suivis")}} className=" flex border-b-2 items-center  border-gray-400 border-opacity-20 hover:opacity-50 py-2 p-1 cursor-pointer">
        <div className=" ml-3">
        ...
        <div onClick={()=>{router.push("/mes-fichiers")}}   className=" flex border-b-2 items-center  border-gray-400 border-opacity-20 hover:opacity-50 py-2 p-1 cursor-pointer">
        <div className=" ml-3">
        ...
        <div  onClick={()=>{router.push("/fichiers-partages")}}   className=" flex border-b-2 items-center  border-gray-400 border-opacity-20 hover:opacity-50 py-2 p-1 cursor-pointer">
        <div className=" ml-3">
        ...
        <div  onClick={()=>{router.push("/recents")}}  className=" flex border-b-2 items-center  border-gray-400 border-opacity-20 hover:opacity-50 py-2 p-1 cursor-pointer">
        <div className=" ml-3">
        ...
        <div onClick={()=>{router.push("/meta-data")}}  className=" flex border-b-2 items-center  border-gray-400 border-opacity-20 hover:opacity-50 py-2 p-1 cursor-pointer">
        <div className=" ml-3">
