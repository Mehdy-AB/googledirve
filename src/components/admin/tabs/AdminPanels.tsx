...
const AdminPanels=({sidebarOpen,onClose})=>{
    const route =useRouter();
return(
    <div className={` bg-foreground text-white grid grid-cols-4 gap-8 p-16 pb-4 rounded-md shadow-xl top-[2.8rem] absolute ${sidebarOpen ? "left-[12.5rem] w-[calc(100%-13rem)]" : "left-[4rem] w-[calc(100%-4rem)] "}`}>
    <div className="">
      <span className="text-2xl font-semibold">Work Flow
      </span>
      <div className="border-b border-gray-400"></div>
      <div className="">
        <button className="grid items-center  w-full p-1 grid-cols-8">
        <svg className="size-6" fill="currentColor" viewBox="0 0 32 32" id="icon" xmlns="http://www.w3.org/2000/svg"><path d="M30,20V12H22v3H17V7a2,2,0,0,0-2-2H10V2H2v8h8V7h5V25a2,2,0,0,0,2,2h5v3h8V22H22v3H17V17h5v3ZM8,8H4V4H8ZM24,24h4v4H24Zm0-10h4v4H24Z" transform="translate(0)"/><rect id="_Transparent_Rectangle_" data-name="&lt;Transparent Rectangle&gt;" fill='none' width="32" height="32"/></svg>                
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-xs flex gap-2 items-center">Workflow Designer
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
                <p className="text-12px">View and edit document approval workflow</p>
            </div>
        </button>
        <button className="grid items-center  w-full p-1 grid-cols-8">
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-xs flex gap-2 items-center">List of tasks
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
                <p className="text-12px">Manage pending tasks or process in workflow 
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-xs flex gap-2 items-center">Working hours
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
                <p className="text-12px">Mange working hours and bank holidays</p>
            </div>
        </button>
    ...
    <div className="col-span-1">
      <span className="text-2xl font-semibold">Uitlisateur

      </span>
      <div className="border-b border-gray-400"></div>
        <div className=" ">
        <button className="grid items-center  w-full p-1 grid-cols-8" onClick={()=>{route.push('/dashboard/admin-panel/users');onClose()}}>
        <svg className="size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
        </svg>
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-xs flex gap-2 items-center">Users
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
                <p className="text-12px">Add, edit, or delete users.</p>
            </div>
        </button>
        <button className="grid items-center  w-full p-1 grid-cols-8"  onClick={()=>{route.push('/dashboard/admin-panel/groups');onClose()}}>
        <svg className="size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z" />
        </svg>
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-xs flex gap-2 items-center">Groups
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
                <p className="text-12px">Manage groups.
                </p>
            </div>
        </button>
        <button className="grid items-center  w-full p-1 grid-cols-8" onClick={()=>{route.push('/dashboard/admin-panel/roles');onClose()}}>
        <svg className="size-6"  viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-xs flex gap-2 items-center">Roles
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
                <p className="text-12px">Manage user roles.</p>
            </div>
        </button>
        <button className="grid items-center  w-full p-1 grid-cols-8">
        <svg className="size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-xs flex gap-2 items-center">Users notifications
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
                <p className="text-12px">View and edit user notifications.</p>
            </div>
        </button>
        <button className="grid items-center  w-full p-1 grid-cols-8">
        <svg className="size-6" fill="currentColor" viewBox="0 0 32 32" id="icon" xmlns="http://www.w3.org/2000/svg"><path d="M30,20V12H22v3H17V7a2,2,0,0,0-2-2H10V2H2v8h8V7h5V25a2,2,0,0,0,2,2h5v3h8V22H22v3H17V17h5v3ZM8,8H4V4H8ZM24,24h4v4H24Zm0-10h4v4H24Z" transform="translate(0)"/><rect id="_Transparent_Rectangle_" data-name="&lt;Transparent Rectangle&gt;" fill='none' width="32" height="32"/></svg>                
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-xs flex gap-2 items-center">Extranet
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
                <p className="text-12px">Manage communication spaces with external users.</p>
            </div>
        </button>
    ...
    <div className="col-span-1">
      <span className="text-2xl font-semibold">Documents
      </span>
      <div className="border-b border-gray-400"></div>
      <div className="">
          <button className="grid items-center  w-full p-1 grid-cols-8">
      ...
      <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                  <span className=" font-semibold text-xs flex gap-2 items-center" onClick={()=>{route.push('/dashboard/admin-panel/documentsManagment');onClose()}}>Filing categories
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg></span>
                  <p className="text-12px">View and edit document types.</p>
              </div>
          </button>
          <button className="grid items-center w-full p-1 grid-cols-8">
          ...
          <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                  <span className=" font-semibold text-xs flex gap-2 items-center">Secured Conservation Spaces
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                  </span>
                  <p className="text-12px">Add or view Secured Conservation Spaces.
                  </p>
              </div>
          </button>
          <button className="grid items-center  w-full p-1 grid-cols-8">
          ...
          <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                  <span className=" font-semibold text-xs flex gap-2 items-center">Folder types
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                  </span>
                  <p className="text-12px">Add, edit, delete the folders types.</p>
              </div>
          </button>
          <button className="grid items-center  w-full p-1 grid-cols-8">
          <svg className="size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
          ...
          <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                  <span className=" font-semibold text-xs flex gap-2 items-center">Links
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                  </span>
                  <p className="text-12px">View and edit dynamic links between document types.</p>
              </div>
          </button>
          <button className="grid items-center  w-full p-1 grid-cols-8">
          ...
          <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                  <span className=" font-semibold text-xs flex gap-2 items-center">Stamps
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                  </span>
                  <p className="text-12px">View and edit workflow stamps.</p>
              </div>
          </button>
          <button className="grid items-center  w-full p-1 grid-cols-8">
          <svg className="size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" >
          ...
          <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                  <span className=" font-semibold text-xs flex gap-2 items-center">Open Bee™ Scan O.C.S
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                  </span>
                  <p className="text-12px">View and edit Open Bee™ Scan O.C.S settings.</p>
              </div>
          </button>
          <button className="grid items-center  w-full p-1 grid-cols-8">
          <svg className="size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
          ...
          <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                  <span className=" font-semibold text-xs flex gap-2 items-center">Share
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                  </span>
                  <p className="text-12px">View and modify shared documents.</p>
              </div>
          </button>
          <button className="grid items-center  w-full p-1 grid-cols-8">
          <svg className="size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
          ...
          <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                  <span className=" font-semibold text-xs flex gap-2 items-center">Recycle bin
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                  </span>
                  <p className="text-12px">View and manage deleted documents and folders.</p>
              </div>
          </button>
          <button className="grid items-center  w-full p-1 grid-cols-8">
          <svg className="size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
          ...
          <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                  <span className=" font-semibold text-xs flex gap-2 items-center">Digital signature
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                  </span>
                  <p className="text-12px">Manage a company signing certificate and the rules of associated application.</p>
              </div>
          </button>
    ...
    <div className="col-span-1">
      <span className="text-2xl font-semibold">System
      </span>
      <div className="border-b border-gray-400"></div>
        <div className="">
        <button className="grid items-center  w-full p-1 grid-cols-8">
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-xs flex gap-2 items-center">DMS Settings
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
                <p className="text-12px">Set general parameters of your Document Management Solution.</p>
            </div>
        </button>
        <button className="grid items-center  w-full p-1 grid-cols-8">
        <svg className="size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-xs flex gap-2 items-center">Customization
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
                <p className="text-12px">Customize the background picture.
                </p>
            </div>
        </button>
        <button className="grid items-center  w-full p-1 grid-cols-8">
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-xs flex gap-2 items-center">Email Customisation
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
                <p className="text-12px">Change the content of sent emails.</p>
            </div>
        </button>
        <button className="grid items-center  w-full p-1 grid-cols-8">
        <svg className="size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-xs flex gap-2 items-center">Emails
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
                <p className="text-12px">Preview and resend all emails generated by the system.</p>
            </div>
        </button>
        <button className="grid items-center  w-full p-1 grid-cols-8">
        <svg className="size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-xs flex gap-2 items-center">Transactions
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
                <p className="text-12px">View transactions and check their integrity.
                </p>
            </div>
        </button>
        <button className="grid items-center  w-full p-1 grid-cols-8">
