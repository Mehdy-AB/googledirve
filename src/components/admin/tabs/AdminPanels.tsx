...
const AdminPanels=({onClose})=>{
    const route =useRouter();
return(
    <div className={` bg-foreground text-white grid grid-cols-4 gap-8 p-16 pb-4 rounded-md shadow-xl top-[5.5rem] absolute left-[17rem] w-[calc(100%-18rem)]`}>
    <div className="col-span-1">
      ...
      <div className="border-b border-gray-400"></div>
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-sm flex gap-2 items-center">DMS Settings
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-sm flex gap-2 items-center">Customization
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-sm flex gap-2 items-center">Email Customisation
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-sm flex gap-2 items-center">Emails
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-sm flex gap-2 items-center">Transactions
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
    ...
    <div className="col-span-1">
      ...
      <div className="border-b border-gray-400"></div>
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-sm flex gap-2 items-center">Users
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-sm flex gap-2 items-center">Groups
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-sm flex gap-2 items-center">Roles
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-sm flex gap-2 items-center">LDAP Servers
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-sm flex gap-2 items-center">Alias
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-sm flex gap-2 items-center">Users notifications
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-sm flex gap-2 items-center">Extranet
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
    ...
    <div className="col-span-1">
      ...
      <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                  <span className=" font-semibold text-sm flex gap-2 items-center" onClick={()=>{route.push('/dashboard/admin-panel/Modeles');onClose()}}>Modeles des documents
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg></span>
          ...
          <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                  <span className=" font-semibold text-sm flex gap-2 items-center">Secured Conservation Spaces
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                  </span>
          ...
          <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                  <span className=" font-semibold text-sm flex gap-2 items-center">Folder types
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                  </span>
          ...
          <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                  <span onClick={()=>{route.push('/dashboard/admin-panel/links');onClose()}} className=" font-semibold text-sm flex gap-2 items-center">Links
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                  </span>
          ...
          <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                  <span className=" font-semibold text-sm flex gap-2 items-center">Stamps
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                  </span>
          ...
          <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                  <span className=" font-semibold text-sm flex gap-2 items-center">Open Bee™ Scan O.C.S
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                  </span>
          ...
          <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                  <span className=" font-semibold text-sm flex gap-2 items-center">Share
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                  </span>
          ...
          <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                  <span className=" font-semibold text-sm flex gap-2 items-center">Recycle bin
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                  </span>
          ...
          <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                  <span className=" font-semibold text-sm flex gap-2 items-center">Digital signature
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                  </span>
    ...
    <div className="">
      ...
      <div className="">
        ...
        <svg className="size-6" fill="currentColor" viewBox="0 0 32 32" id="icon" xmlns="http://www.w3.org/2000/svg"><path d="M30,20V12H22v3H17V7a2,2,0,0,0-2-2H10V2H2v8h8V7h5V25a2,2,0,0,0,2,2h5v3h8V22H22v3H17V17h5v3ZM8,8H4V4H8ZM24,24h4v4H24Zm0-10h4v4H24Z" transform="translate(0)"/><rect id="_Transparent_Rectangle_" data-name="&lt;Transparent Rectangle&gt;" fill='none' width="32" height="32"/></svg>                
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-sm flex gap-2 items-center">Workflow Designer
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-sm flex gap-2 items-center">List of tasks
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
        ...
        <div className="ml-2 text-start col-span-7 hover:text-gray-200 group">
                <span className=" font-semibold text-sm flex gap-2 items-center">Working hours
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 group-hover:opacity-90 opacity-0 duration-200 transition-opacity">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
                </span>
