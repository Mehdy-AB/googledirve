...
const DisplayUserTable=({user,setUserInfo,setEditUser,setShowCreate,deleteUser})=>{
    return(
        <tr  className="odd:bg-blue-50">
                                <td className="pl-4 w-8">
                                    <input id={"checkbox"+user?.id} type="checkbox" className="hidden peer" />
                                ...
                                <td className="p-4 text-sm">
                                    <div onClick={()=>{setUserInfo(user.id)}} className="flex items-center cursor-pointer w-max">
                                ...
                                <td className="p-4">
                                    <label className="relative cursor-pointer">
                                        <input type="checkbox" className="sr-only peer" checked={user?.enabled} />
                                        <div
                                ...
                                <td className="p-4">
                                    <button onClick={()=>{setEditUser(user),setShowCreate(true)}} className="mr-4" title="Edit">
